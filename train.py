...
parser.add_argument("-c", "--config", default="./conf/cifar10-dvs.yml", type=str, metavar="FILE",
...
parser.add_argument("--model", default="hybrid_former", type=str, metavar="MODEL",
                    help='Name of model to train (default: "hybrid_former")')

parser.add_argument("--pooling_stat", default="1111", type=str,
                    help="pooling layers in SPS moduls")

parser.add_argument("--use_conv_as_linear", default=True, type=bool,
                    help="")

parser.add_argument("--cml", default=False, type=bool,
                    help="")
...
parser.add_argument("--attn-mode", default="direct_xor", type=str,
                    help="")
...
parser.add_argument("--dvs-aug", action="store_true", default=False,
                    help="disable fast prefetcher")

parser.add_argument("--dvs-trival-aug", action="store_true", default=False,
                    help="disable fast prefetcher")
